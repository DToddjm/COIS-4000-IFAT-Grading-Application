...
public class IFATController {
    ...
    public Hashtable<String, StudentIFATCard> loadCards(String folder) {
        // create a hashtable to store a list of IFAT cards
        // the key will be the filepath (for now) and the value is the IFAT card obj
        ...
        try {
            ...
            for (int i = 0; i < allFiles.length; i++) {
                ...
                studentCardTable.put(filepath, card);
            }
        } catch (Exception e) {

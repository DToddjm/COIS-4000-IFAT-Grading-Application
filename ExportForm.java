    ...
    private void btn_ExportActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (!txt_Folder.getText().isEmpty()) {
            try {
                ...
                // Pass the studentCardTable and the output directory to writeDetailCSVs
                outputCSV.writeDetailCSVs(new ArrayList<>(studentCardTable.values()), outputDir);
            } catch (Exception e) {
                e.printStackTrace();
            ...
            JOptionPane.showMessageDialog(this, "Please select a folder to export the data.", "Export Error", JOptionPane.ERROR_MESSAGE);
        }
    }
